...
function initcloud()
    cloud = {
        ...
        message=mlist[flr(rnd(5))+1],
        cornersprite=016,
        w=24, h=16
    }
    cloud.draw = function(self)
        spr(self.cornersprite, self.x, self.y - cam.y/16, self.w/8, self.h/8)
        printc(self.message, self.x + self.w/2, self.y + self.h/2 - 3 - cam.y/16, black)
    end
    cloud.update = function(self)
        if self.x > 120 or self.x < -16 or self.y - cam.y/16 < -18 or self.y - cam.y/16 > 122 then
            self:respawn()
        end
        self.x += self.dx
    end
    cloud.respawn = function(self)
        self.message = mlist[flr(rnd(5))+1]
        if rnd() > 0.5 then
            self.x = -16
            self.dx = rnd(0.075)
        else
...
function printc(text, x, y, color) --Identical to print(text, x, y, color), but horizontally centered on x rather than left-aligned.
    local w = print(text, 0, 128)
    return print(text, x-w/2, y, color)
end
...

...

